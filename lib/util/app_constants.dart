...
class AppConstants {
  ...
  static const int subcatid = 27;
  static const Color primary = Color(0xFF4B39EF);
  static const String authStorage = 'r_authorization_token';
  static const String packageName = 'com.msslearn.r';
  static const String appName = 'R';
