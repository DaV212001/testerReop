...
class AppConstants {
  ...
  static const int subcatid = 19;
  static const Color primary = Color(0xFF4B39EF);
  static const String authStorage = 'wd_authorization_token';
  static const String packageName = 'com.msslearn.web_development';
  static const String appName = 'Web Development';
