...
class AppConstants {
  ...
  static const int subcatid = 23;
  static const Color primary = Color(0xFF4B39EF);
  static const String authStorage = 'phpmdmn_authorization_token';
  static const String packageName = 'com.msslearn.php_my_admin';
  static const String appName = 'phpMyAdmin';
