          ...
          children: [
            Obx(() => controller.isLoading
                ...
                : RefreshIndicator(
                    ...
                    displacement: 100,
                    onRefresh: () =>
                        controller.getLevels(controller.subCategoryId.value),
                        ...
                        return Accordion(
                          ...
                          children: [
                            AccordionSection(
                              ...
                              leftIcon:
                                  Icon(Icons.circle, color: theme.primary),
                              ...
                              header: Text(
                                  controller.listOfAllLevels[index1].name,
                                  style: TextStyle(
                                      fontSize: 18, color: theme.primaryText)),
                              content: ListView.builder(
                                  itemCount: controller
                                      .listOfAllLevels[index1].lessons.length,
                                  scrollDirection: Axis.vertical,
                                  physics: const BouncingScrollPhysics(),
                                  shrinkWrap: true,
